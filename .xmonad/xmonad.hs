...
-- LAYOUTS
layouts = (renamed [Replace "master/stack"] $ spacingWithEdge 7 $ tiled) ||| (renamed [Replace "broad"] $ spacingWithEdge 7 $ Mirror tiled) ||| (renamed [Replace "fullscreen"] $ Full)
  where
...
xmobarOut = def
    ...
    , ppWsSep		    = " | "
    , ppCurrent         = xmobarBorder "Bottom" "#afa193" 3 . wrap "   " "   " . xmobarColor "#ffffff" "" 
    , ppHidden          = xmobarColor "#cacaca" "" . wrap "   " "   "
    , ppTitle		    = wrap "[ " " ]" . xmobarColor "#cacaca" "" . shorten 50
    , ppLayout		    = wrap "[ " " ]" . xmobarColor "#afa193" ""
